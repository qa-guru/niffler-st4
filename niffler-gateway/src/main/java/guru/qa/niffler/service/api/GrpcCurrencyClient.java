...
public class GrpcCurrencyClient {
  ...
  public void setNifflerCurrencyServiceStub(@GrpcClient("grpcCurrencyClient") NifflerCurrencyServiceGrpc.NifflerCurrencyServiceBlockingStub nifflerCurrencyServiceStub) {
