...
public interface UserRepository {
    ...
    Optional<UserAuthEntity> getUserFromAuth(UUID id);

    Optional<UserEntity> getUserFromUserData(UUID id);

    Optional<UserAuthEntity> updateUserInAuth(UserAuthEntity user);
